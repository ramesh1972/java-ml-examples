...
/***
 * THis project demonstrates how to detect house numbers that might be in images or video frames
 * to mask them in those images to hide from public view
 */
public class TinyYoloHouseNumberDetection {
    ...
    public static void main(String[] args) throws java.lang.Exception {
        ...
        // fetch the street view house number images
        // split for train and eval
        ...
        // create the object reader using the street view house number providers
        ...
        RecordReaderDataSetIterator test = new RecordReaderDataSetIterator(recordReaderTest, 100, 1, 1, true);
        ...
        if (new File(modelFilename).exists()) {
            ...
            // ND4J is provides interface to create n-dimensional arrays
            INDArray priors = Nd4j.create(priorBoxes);

            // fine tune the model creation based on certain parameters
            ...
            // listen for progress
            model.setListeners(new ScoreIterationListener(10), new StatsListener( statsStorage), new EvaluativeListener(test, 1, InvocationType.ITERATION_END));
