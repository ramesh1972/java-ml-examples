...
import com.ramesh.dl4j.objectdetection.MultiRecordDataSetIterator;
...
public class MultiDigitNumberRecognition {
   ...
   public static void main(String[] args) throws Exception {
       ...
       // create directory
       if (!modelDir.exists()) { // no inspection ResultOfMethodCallIgnored
           modelDir.mkdirs(); }
       ...
       // fit
       model.setListeners(new ScoreIterationListener(10), new StatsListener( statsStorage), new EvaluativeListener(testMulIterator, 1, InvocationType.ITERATION_END));
       int epochs = 4;
   ...
   private static ComputationGraph createModel() {
	   ...
	   // create the layers of the neural network (CNN)
       long seed = 123;
   ...
   // get the house number image coordinates or label for the input/eval dataset
